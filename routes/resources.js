...
const { getCurrentExpiry, validateVoucher, redeemVoucher, authenticateWithToken, verifyAppleReceipt, addTimeToExpiry} = require('../utils');
...
router.post('/v1/create-apple-payment', authenticateWithToken, async (req, res) => {
    ...
    try {
        ...
        const jsonResponse = { time_added: timeAdded, new_expiry: newExpiry };
